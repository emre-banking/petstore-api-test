...
import api.endpoints.UserEndPointsRoutesProperties;
...
public class UserTestsProperty {
    ...
    {
        Response response = UserEndPointsRoutesProperties.createUser(userPayload);
    ...
    {
        Response response = UserEndPointsRoutesProperties.readUser(this.userPayload.getUsername());
    ...
    public void testUpdateUserByName()
    {
        ...
        Response response = UserEndPointsRoutesProperties.updateUser(this.userPayload.getUsername(),userPayload);
        response.then().log().all();
    ...
    {
        Response response = UserEndPointsRoutesProperties.deleteUser(this.userPayload.getUsername());
        response.then().log().all();
